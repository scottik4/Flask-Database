...
def upgrade():
    ...
    sa.Column('Hribek', sa.String(), nullable=False),
    ...
    op.create_index('ix_loguser_Hribek', 'loguser', ['Hribek'], unique=False)
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('karty')
    op.drop_index('ix_loguser_Hribek', table_name='loguser')
